...
export const getOtpHtml = ({ email, otp }: OtpHtmlOptions) => {
        ...
        <table role="presentation" class="container" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="p-32">
              ...
              <p class="muted">If you did not initiate this request, you can safely ignore this email.</p>
            </td>
          </tr>
...
export const getVerifyEmailHtml = ({ email, token }: VerifyEmailOptions) => {
...
interface ForgotPasswordOtpOptions {
  email: string;
  otp: string | number;
}

export const getForgotPasswordOtpHtml = ({
  email,
  otp,
}: ForgotPasswordOtpOptions) => {
  const appName = process.env.APP_NAME || "Authentication App";
        ...
        <table role="presentation" class="container" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td class="p-32">
              ...
              <p class="muted">This code will expire in <strong>5 minutes</strong>.</p>
              <p class="muted">If you did not request a password reset, you can safely ignore this email. Your password will not be changed.</p>
            </td>
          </tr>
